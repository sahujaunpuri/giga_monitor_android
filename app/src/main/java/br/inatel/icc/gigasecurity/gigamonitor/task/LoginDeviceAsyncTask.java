...
public class LoginDeviceAsyncTask extends AsyncTask<Void, Void, Long> {
    ...
    //private WeakReference<AsyncTaskFragment> fragmentWeakRef;
    ...
    protected void onPreExecute() {
        ...
        mProgressDialog = ProgressDialog.show(mContext, "", mContext.getResources().getString(R.string.label_connecting, true));
