...
public class MyTimelineActivity extends ActionBarActivity {
    ...
    public ArrayList<SurfaceViewComponent> favoritesViews = new ArrayList<SurfaceViewComponent>();
    ...
    private LoginDeviceListener loginListener = new LoginDeviceListener() {
        ...
        public void onLoginSuccess(Device device) {
            for(SurfaceViewComponent surfaceViewComponent : favoritesViews){
                surfaceViewComponent.onPlayLive();
            }
        }
    ...
    private void createSurfaceView(String serialNumber, int channelNumber){
        ...
        surfaceViewComponent.mySurfaceViewChannelId = channelNumber;
        surfaceViewComponent.mySurfaceViewOrderId = nFavorites++;
        surfaceViewComponent.deviceSn = serialNumber;
