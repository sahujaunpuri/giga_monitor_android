...
public class PasswordConfigActivity extends ActionBarActivity {
    ...
    private void save() {
        ...
        changePsw.setsNewPassword(newPass);
        changePsw.setsPassword(oldPass);
        changePsw.setsUserName("admin");

        if(mManager.setConfig2(loginId, MyConfig.SdkConfigType.E_SDK_CONFIG_MODIFY_PSW, changePsw)) {
            Log.w("CHANGE PASS" , "OK");
        } else {
            Log.w("CHANGE PASS" , "ERROR");
        }*/
