...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
  ...
  private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
    //Toast.makeText(CaptureActivity.this, "QRCode Result: " + rawResult.getText(), Toast.LENGTH_LONG).show();
    startNewDeviceActivity(rawResult.getText());
  }

  private void startNewDeviceActivity(String serialNumber) {
